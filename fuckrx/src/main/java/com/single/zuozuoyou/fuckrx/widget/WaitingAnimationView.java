...
public class WaitingAnimationView extends View {
    ...
    public WaitingAnimationView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public WaitingAnimationView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public WaitingAnimationView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        //颜色
        mIndicatorColor = context.getResources().getColor(R.color.colorPrimaryDark);
        mPaint = new Paint();
